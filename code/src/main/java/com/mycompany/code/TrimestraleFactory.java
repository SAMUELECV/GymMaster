 ...
 * @author carlo
 */
public class TrimestraleFactory extends AbbonamentoFactory {
    
    private static int contatoreId = 1;
    
    @Override
    public Abbonamento creaAbbonamento(Iscritto i, Date datainizio) {
        Date datafine = calcolaDataFine(datainizio, 90); // 90 giorni
        ...
        System.out.println("Abbonamento TRIMESTRALE creato - ID: " + a.getIdabbonamento());

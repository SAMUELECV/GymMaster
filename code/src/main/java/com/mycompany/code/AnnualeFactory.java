 ...
 * @author carlo
 */
public class AnnualeFactory extends AbbonamentoFactory {
    
    private static int contatoreId = 1;
    
    @Override
    public Abbonamento creaAbbonamento(Iscritto i, Date datainizio) {
        Date datafine = calcolaDataFine(datainizio, 365); // 365 giorni
        ...
        System.out.println("Abbonamento ANNUALE creato - ID: " + a.getIdabbonamento());
